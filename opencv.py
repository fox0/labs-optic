...
# цель, задачи исследования, название
# > и технические характеристики установки, описание методов расчёта, выводы
# > писать придется. Хоть как, но придется.

# Необходимо определить полное
# > количество фаз и соответственно их относительное содержание.

# "фазовый состав
# > данного материала представлен хх% фазы, уу% другой фазы и т.д."

# необходимо эти выборки оценить на наличие ошибок а также
# > определить величину этой ошибки.
...
def main():
    ...
    plt.subplot(311)
    plt.hist(result0, 5, density=True, facecolor='r')
    plt.yticks([])

    plt.subplot(312)
    plt.yticks([])
    plt.hist(result1, 5, density=True, facecolor='g')

    plt.subplot(313)
    plt.yticks([])
    plt.hist(result2, 5, density=True, facecolor='b')
